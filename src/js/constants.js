...
const userCharacters = {
    ...
    special: [
        { 
            ...
            audio: new Audio("/assets/audio/charmignon.mp3")},
        { 
            name: 'Charmignon',
            src: '/assets/img/frame/special/charmignon.webp',
        ...
        { 
            name: 'Devine',
            src: '/assets/img/frame/special/devine.webp',
        ...
        { 
            name: 'Hontoscope',
            src: '/assets/img/frame/special/hontoscope.webp',
            ...
            audio: new Audio("/assets/audio/hontoscope.mp3")}
    ]
};
...
const iaCharacters = {
    ...
    special: [
        { 
            ...
            audio: new Audio("/assets/audio/special_ia.mp3")},
        { 
            name: 'Vertuose VI', 
            src: '/assets/img/frame/special/vertuose.webp',
        ...
        { 
            name: 'Veulerine', 
            src: '/assets/img/frame/special/veulerine.webp',
...
const gameEvent = [
    { 
        ...
        src: '/assets/img/frame/event/sarcophage.webp',
        ...
        audio: new Audio("/assets/audio/sarcophage.mp3")},
    { 
        name: 'Barbegarde', 
        src: '/assets/img/frame/event/barbegarde.webp',
        ...
        audio: new Audio("/assets/audio/barbegarde.mp3")},
    { 
        name: 'Créateur', 
        src: '/assets/img/frame/event/createur.webp',
        ...
        audio: new Audio("/assets/audio/createur.mp3")}
];
...
const gameOver = [
    { 
        title: 'Défaite', 
        banner: '/assets/img/others/defeat.webp',
        audio: new Audio("/assets/audio/defeat.mp3")},
    { 
        title: 'Victoire', 
        banner: '/assets/img/others/victory.webp',
        audio: new Audio("/assets/audio/victory.mp3")},
    { 
        title: 'Egalité', 
        banner: '/assets/img/others/equality.webp',
        audio: new Audio("/assets/audio/egalite.mp3")}
];
